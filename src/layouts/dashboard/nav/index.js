  ...
  const renderContent = (
    ...
    >
      ...
      <Box sx={{ mb: 5, mx: 2.5, mt: 5 }}>
        <Link underline="none">
          <StyledAccount>
            <Avatar src={"https://lh3.googleusercontent.com/XpoM86_fgcDAZI4R87gVUdJs6etNjQ1TpNlYfLt5T7GvqoWoLnwAtNevdQyHNujYgT-rtXPmAJqfvs30wh8RLMfPR0pcVKN8HDf7-Yqy7TbKd_AN1e3yM-GHI1eSywuNEvSmhxc7=w2400"} alt="photoURL"/>
    ...
    >
      {isDesktop ? (
        ...
        <Drawer
          ...
          PaperProps={{
            sx: { width: NAV_WIDTH, bgcolor: '#fff',
            boxShadow: "rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset" },
          }}
        >
          {renderContent}
